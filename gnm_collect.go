...
func loadReports() []gnmsys.ReportFactory {
	return [] gnmsys.ReportFactory{
		...
		gnmsys.LineReportFactoryBuilder{
			...
			CollectorFactories: []gnmsys.CollectorFactory{
				gnmsys.NewFloatCollector("System", "java.lang.management.OperatingSystemMXBean",
					"System_CPU_Load", "value"),
				gnmsys.NewFloatCollector("Process", "java.lang.management.OperatingSystemMXBean",
		...
		gnmsys.LineReportFactoryBuilder{
			Title: "Mean Logging Events",
			Filename: "mean_logging_events",
			YAxis: "Events / second",
			X: 12 * vg.Inch,
			Y: 5 * vg.Inch,
			CollectorFactories: []gnmsys.CollectorFactory{
				gnmsys.NewFloatCollector("All", "org.apache.log4j.Appender",
					"all", "mean"),
				gnmsys.NewFloatCollector("Fatal", "org.apache.log4j.Appender",
					"fatal", "mean"),
				gnmsys.NewFloatCollector("Error", "org.apache.log4j.Appender",
					"error", "mean"),
				gnmsys.NewFloatCollector("Warn", "org.apache.log4j.Appender",
					"warn", "mean"),
				gnmsys.NewFloatCollector("Info", "org.apache.log4j.Appender",
					"info", "mean"),
				gnmsys.NewFloatCollector("Debug", "org.apache.log4j.Appender",
					"debug", "mean"),
				gnmsys.NewFloatCollector("Trace", "org.apache.log4j.Appender",
					"trace", "mean")}}.ToRequestFactory(),
		gnmsys.LineReportFactoryBuilder{
			Title: "Mean Web Requests",
			Filename: "mean_web_requests",
			YAxis: "requests / second",
			X: 12 * vg.Inch,
			Y: 5 * vg.Inch,
			CollectorFactories: []gnmsys.CollectorFactory{
				gnmsys.NewFloatCollector("Requests", "org.fao.geonet.monitor.webapp.WebappMetricsFilter",
					"requests", "rate", "mean")}}.ToRequestFactory(),
		gnmsys.LineReportFactoryBuilder{
			Title: "Active Web Requests",
			Filename: "active_web_requests",
			YAxis: "requests / second",
			X: 12 * vg.Inch,
			Y: 5 * vg.Inch,
			CollectorFactories: []gnmsys.CollectorFactory{
				gnmsys.NewFloatCollector("Requests", "org.fao.geonet.monitor.webapp.WebappMetricsFilter",
					"activeRequests", "count")}}.ToRequestFactory(),
		gnmsys.LineReportFactoryBuilder{
			Title: "Server Response Codes",
			Filename: "server_response_codes",
			YAxis: "responses / second",
			X: 12 * vg.Inch,
			Y: 5 * vg.Inch,
			CollectorFactories: []gnmsys.CollectorFactory{
				gnmsys.NewFloatCollector("Bad", "org.fao.geonet.monitor.webapp.WebappMetricsFilter",
					"responseCodes.badRequest", "mean"),
				gnmsys.NewFloatCollector("NoContent", "org.fao.geonet.monitor.webapp.WebappMetricsFilter",
					"responseCodes.noContent", "mean"),
				gnmsys.NewFloatCollector("NotFound", "org.fao.geonet.monitor.webapp.WebappMetricsFilter",
					"responseCodes.notFound", "mean"),
				gnmsys.NewFloatCollector("Ok", "org.fao.geonet.monitor.webapp.WebappMetricsFilter",
					"responseCodes.ok", "mean"),
				gnmsys.NewFloatCollector("Other", "org.fao.geonet.monitor.webapp.WebappMetricsFilter",
					"responseCodes.other", "mean"),
				gnmsys.NewFloatCollector("ServerError", "org.fao.geonet.monitor.webapp.WebappMetricsFilter",
					"responseCodes.serverError", "mean"),
				gnmsys.NewFloatCollector("Created", "org.fao.geonet.monitor.webapp.WebappMetricsFilter",
					"responseCodes.created", "mean")}}.ToRequestFactory(),
		gnmsys.LineReportFactoryBuilder{
			Title: "Duration Web Requests",
			Filename: "duration_web_requests",
			YAxis: "milliseconds",
			X: 12 * vg.Inch,
			Y: 5 * vg.Inch,
			CollectorFactories: []gnmsys.CollectorFactory{
				gnmsys.NewFloatCollector("Requests", "org.fao.geonet.monitor.webapp.WebappMetricsFilter",
					"requests", "duration", "mean")}}.ToRequestFactory(),
		gnmsys.LineReportFactoryBuilder{
			Title: "Thread states (%)",
